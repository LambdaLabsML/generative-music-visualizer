...
examples = [
    [
        "examples/Maple_leaf_rag_-_played_by_Scott_Joplin_1916_V2.ogg",
        network_choices[0],
        1.0,
        0.25,
        0.5,
    ...
    [
        "examples/Muriel-Nguyen-Xuan-Beethovens-Moonlight-Sonata-mvt-3.ogx",
        network_choices[4],
        1.2,
        0.3,
        0.5,
...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(
            minimum=64, value=512, maximum=1024, step=64, label="Frame Length (samples)"
        ),
        gr.Slider(
            minimum=1, value=300, maximum=600, step=1, label="Max Duration (seconds)"
        ),
    ],
    # examples=examples,
    outputs=gr.Video(),
